...
<head>
    ...
    posthog.init('phc_mXUZ1oFYrC0A7x0hnCcwg0FmT1CFf5cuLKbbSctyhu5',{api_host:'https://web-f4cwsw04cs4wo40c0kokw440.worldofeditors.net', person_profiles: 'identified_only' // or 'always' to create profiles for anonymous users as well
        })
    </script>
</head>
<style>
